...
@section('content')
    <main class="container mt-5 pt-5">
        ...
        <h1 class="text-center" style="font-family: Shadows Into Light, cursive; color: #26316A; font-size: 300%">Mon compte
        </h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-10 offset-1 text-center">
                        <form class="col-12 mx-auto p-5 border border-primary" action="{{ route('users.update', $user) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center p-4"> Mes commandes</h4>

                @if (isset($user->commandes) && count($user->commandes) > 0)
                    <div class="row">
                        <div class="col-10 offset-1 text-center">
                            <table class="table table border border-primary col-12 mx-auto p-5">
                                ...
                                <div class="card text-center col-md-4 col-lg-3 p-3 m-3\" style="width: 18rem;">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{ route('reservations.destroy', $evenement->id) }}">
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-danger m-2">Annnuler
